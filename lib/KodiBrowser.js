		...
		switch(media_item_type) {
			case 'song':
				try {
					...
					if(artist_thumb) o.thumbnailUri = this.controller.fetchKodiImage(this.id, artist_thumb, 80)
					list.addListItem(o);
					...
					if(i.album) {
						...
						if(i.thumbnail) o.thumbnailUri = this.controller.fetchKodiImage(this.id, i.thumbnail, 80)
						list.addListItem(o);
					}
					if(i.lyrics) {
