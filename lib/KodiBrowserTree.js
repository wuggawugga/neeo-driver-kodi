	...
	//				action: {method: 'getArtistsByGenre', param_key: 'genreid'}
			...
			albums: {
				...
				by_genre: {
					...
					list: {
						method: 'AudioLibrary.GetGenres', key: 'genres', params: {properties: ["title", "thumbnail", "displayartist"], sort: {method: "title"}},
						item_label: 'displayartist', item_path: '/music/album/*', item_key: "albumid"
					},
					action: {method: 'getArtistsByGenre', param_key: 'genreid'}
				},
				by_title: {
					...
					list: {
						method: 'AudioLibrary.GetAlbums', key: 'albums', params: {properties: ["title", "thumbnail", "displayartist"], sort: {method: "title"}},
						item_label: 'displayartist', item_path: '/music/album/*', item_key: "albumid"
					},
				},
				random: {
