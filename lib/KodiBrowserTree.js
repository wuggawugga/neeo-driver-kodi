		...
		pvr: {
			...
			*/
			channels_radio: {
				...
				recently_played: {
					title: 'Radio Channels',
					label: 'PVR radio channels',
					list: {
						thumbnails: true, method: 'PVR.GetChannels', key: 'channels', params: { channelgroupid: "allradio", properties: ["thumbnail", "channeltype", "hidden", "locked", "channel", "broadcastnow"], sort: {method: 'channel', order: 'ascending'} },
						item_label: 'channel', item_path: '/pvr/channel/*', item_key: 'channelid'
					},
				},
			},
			/*
			...
			*/
			channels_radio: {
				...
				recently_played: {
					title: 'TV Channels',
					label: 'PVR TV channels',
					list: {
						thumbnails: true, method: 'PVR.GetChannels', key: 'channels', params: { channelgroupid: "alltv", properties: ["thumbnail", "channeltype", "hidden", "locked", "channel", "broadcastnow"], sort: {method: 'channel', order: 'ascending'} },
						item_label: 'channel', item_path: '/pvr/channel/*', item_key: 'channelid'
					},
				},
			},
			...
			*/
			recordings: {
				...
				recently_played: {
					title: 'Recordings',
					label: 'PVR recordings',
					list: {
						thumbnails: true, method: 'PVR.GetRecordings', key: 'channels', params: { properties: ["title", "starttime", "endtime", "art"], sort: {method: 'title', order: 'ascending'} },
						item_label: 'channel', item_path: '/pvr/recording/*', item_key: 'recordingid'
					},
				},
			},
		},
