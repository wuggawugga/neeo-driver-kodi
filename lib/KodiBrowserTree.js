 ...
 */
			songs: {
				...
				recently_added: {
					...
					list: {
						method: 'AudioLibrary.GetRecentlyAddedSongs', key: 'songs', params: {properties: ['title', 'thumbnail', 'displayartist'], sort: {method: 'title'}},
				...
				recently_played: {
					...
					list: {
						method: 'AudioLibrary.GetRecentlyPlayedSongs', key: 'songs', params: {properties: ['title', 'thumbnail', 'displayartist'], sort: {method: 'title'}},
						item_label: 'displayartist', item_path: '/audio/song/*', item_key: 'songid'
					},
				},
				top_songs: {
