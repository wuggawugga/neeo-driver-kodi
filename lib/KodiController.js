...
/*
  ...
  kodiUrl(device_id, target_url) {
    ...
    if(this.instances[device_id].auth == true) {
      // FIXME: Dirty lazy hack. Registration doesn't quite work. CBA to fix ATM.
      if(this.instances[device_id].username == undefined) this.instances[device_id].username = 'kodi';
      if(this.instances[device_id].password == undefined) this.instances[device_id].password = 'kodi';
   ...
   *  the errors.
   *  FIXME: Test if the loop is actually necessary. The fault maight have
