  ...
  listAction(device_id, directory_id, params) {
    ...
    if(params.actionIdentifier) {
      ...
      switch(argv[0]) {
        case 'KodiBrowser':
          debug('BROWSER');
          this.browsers[device_id].listAction(directory_id, params);
          break;
        case 'KodiLibrary':
          this.browsers[device_id].library.listAction(directory_id, params);
//          this.browsers[device_id].library.argv[1](argv[2]);
          break;
        case 'API':
          debug('API');
          switch(argv[1]) {
